...
* 引脚图
 ...
 ![image-20240818210823719](README.assets\image-20240818210823719.png)![img](https://ask.qcloudimg.com/http-save/yehe-8223537/623b935a1daa83a83faba696301111da.png)
...
* 说明
    ...
    | 2    | RST      | B24     | 可选RESET，仿真器输出至目标CPU的系统复位信号。               |
    | 3    | TDI/TX   | A8      | TX串口发送                                                   |
    | 4    | GND      | B28     | 接地                                                         |
    | 5    | RX       | A7      | RX串口接收                                                   |
    | 6    | CLK      | B26     | SWCLK，串行时钟输入。作为仿真信号的时钟信号线，建议下拉。    |
    | 7    | GND      | B19     | 接地                                                         |
    | 8    | DIO/TMS  | B25     | SWDIO，串行数据输入输出。作为仿真信号的双向数据信号线，建议上拉。 |
    | 9    | 5V       | B20     | 对外供电，输出5v                                             |
    | 10   | 3V3/VRef | B21/B27 | VRef，目标板参考电压信号，用于检查目标板是否供电，直接与目标板VDD联，并不对外输出电压。 |
